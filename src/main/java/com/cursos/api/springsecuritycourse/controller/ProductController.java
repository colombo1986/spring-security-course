...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<Product> createOne(@RequestBody @Valid SaveProduct savedProduct){

        Product product = productService.createOne(savedProduct);
    ...
    public ResponseEntity<Product> updateOneById(@PathVariable Long productId,
                                                 @RequestBody @Valid SaveProduct savedProduct){

        Product product = productService.updateOneById(productId, savedProduct);
